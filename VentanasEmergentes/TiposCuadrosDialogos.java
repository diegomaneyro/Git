	...
	private class Accion_botones implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			if(e.getSource()==boton1){
				...
				//JOptionPane.showInputDialog(Lamina_Cuadros_Dialogos.this, "Ingrese nombre");
				JOptionPane.showInputDialog(Lamina_Cuadros_Dialogos.this, "Ingrese nombre", "Formulario", 2);
				...
				JOptionPane.showConfirmDialog(Lamina_Cuadros_Dialogos.this, "Elije una opcion", "Confirmar", 2);
				...
				JOptionPane.showOptionDialog(Lamina_Cuadros_Dialogos.this, "Elije", "Opciones", 1, 1, null, null, null);
